/*
 * Classe Function :
 * Permet de traiter la variable qui a pour type "Function".
*/
...
function Function()
{
	...
	this.valeur = "";		// valeur de notre variable function.
	this.nom = "function";	// représente le type de la variable, utile pour récupérer la valeur de notre variable function.
	...
	/*
	 * Fonction qui permet de récupérer la valeur donnée à notre variable de type function.
	 *
	 */
	/*{
