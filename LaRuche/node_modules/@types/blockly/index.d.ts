...
declare module Blockly {
    ...
    class BlockDragSurfaceSvg__Class  {
             ...
             */
            clearAndHide(newSurface: Element): void;
    }
...
declare module Blockly {
    ...
    class BlockSvg__Class extends Blockly.Block__Class  {
             ...
             * @private
             */
            updateCursor_(e: Event, closestConnection: Blockly.Connection): boolean;
...
//    function register(name: string, initFn: function): void;
     ...
     * @private
     */
    function checkHasFunction_(errorPrefix: string, object: Object, propertyName: string): void;
...
declare module Blockly.Touch {
     ...
     * @private
     */
    var touchIdentifier_: DOMString;
...
declare module Blockly {
    ...
    class VariableModel__Class  {
             ...
             * @constructor
             */
            constructor(name: string, opt_type: string, opt_id: string);
...
declare module Blockly.Variables {
    ...
    */
     ...
     */
    function createVariable(workspace: Blockly.Workspace, opt_callback?: { (_0: string): any /*missing*/ }): void;
...
declare module Blockly {
    ...
    class Workspace__Class  {
             ...
             * @private
             */
            deleteVariableInternal_(name: any /* jsdoc error */): void;
