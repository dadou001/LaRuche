Blockly.Blocks['wims_start'] = {
  init: function() {
    ...
    this.setNextStatement(true, 'var_declaration');
    this.setColour(0);
    this.setTooltip('');
    this.setHelpUrl('');
  }
...
Blockly.Blocks['wims_declaration'] = {
  init: function() {
    ...
    this.setPreviousStatement(true, 'var_declaration');
    this.setNextStatement(true, 'preparation_code');
    this.setColour(0);
    this.setTooltip('');
    this.setHelpUrl('');
  }
...
Blockly.Blocks['wims_while'] = {
  init: function() {
    ...
    this.appendStatementInput("WHILE")
        .setCheck(null)
        .appendField("Do");
    this.setPreviousStatement(true, 'preparation_code');
    this.setNextStatement(true, 'preparation_code');
    this.setColour(260);
    this.setTooltip('');
    this.setHelpUrl('');
...
Blockly.Blocks['wims_change_type'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldVariable(getFirstVarName()), "VARIABLE_CHOICE")
    // this.appendDummyInput()
...
Blockly.Blocks['wims_start_analysis'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("","editor_title_block"), "START_TEXT");
